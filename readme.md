...
[![Changelog](https://img.shields.io/badge/Changelog-v0.7.3-orange)](CHANGELOG.md)
...
```powershell
# Clone the repo
git clone https://github.com/alimtvnetwork/scripts-fixture-v6.git scripts-fixture
cd scripts-fixture
```

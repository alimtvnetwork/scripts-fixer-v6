# --------------------------------------------------------------------------
#  Script 27 -- Install Elasticsearch
...
. (Join-Path $scriptDir "helpers\elasticsearch.ps1")
...
if ($isSystem) {
    ...
    $installPath = Join-Path $devDir "elasticsearch"
}
...
# -- Install -------------------------------------------------------------------
$ok = Install-Elasticsearch -DbConfig $config.database -LogMessages $logMessages -InstallPath $installPath

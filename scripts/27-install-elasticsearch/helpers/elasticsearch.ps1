# --------------------------------------------------------------------------
#  Helper -- Elasticsearch installer
# --------------------------------------------------------------------------
...
function Install-Elasticsearch {
    <#
    .SYNOPSIS
        Installs Elasticsearch and verifies the installation.
    ...
    if ($cmd) {
        ...
        Save-ResolvedData -ScriptFolder "27-install-elasticsearch" -Data @{
    ...
    if ($hasCustomPath) {
        $dbInstallDir = Join-Path $InstallPath "elasticsearch"

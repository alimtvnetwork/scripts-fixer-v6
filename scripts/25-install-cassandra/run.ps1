# --------------------------------------------------------------------------
#  Script 25 -- Install Apache Cassandra
...
if ($isSystem) {
    ...
    $installPath = Join-Path $devDir "cassandra"
}
...
# -- Install -------------------------------------------------------------------
$ok = Install-Cassandra -DbConfig $config.database -LogMessages $logMessages -InstallPath $installPath

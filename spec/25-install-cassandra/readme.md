# Spec: Script 25 -- Install Apache Cassandra

## Purpose

Installs Apache Cassandra with flexible installation path options.
Wide-column distributed NoSQL database.

## Usage

```powershell
.\run.ps1          # Install Apache Cassandra (interactive path prompt)
...
1. **Dev directory** (default): `E:\dev\cassandra`

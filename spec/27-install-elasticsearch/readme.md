# Spec: Script 27 -- Install Elasticsearch

## Purpose

Installs Elasticsearch with flexible installation path options.
Full-text search and analytics engine.

## Usage

```powershell
.\run.ps1          # Install Elasticsearch (interactive path prompt)

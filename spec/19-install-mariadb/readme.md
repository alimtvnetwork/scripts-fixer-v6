# Spec: Script 19 -- Install MariaDB

## Purpose

Installs MariaDB with flexible installation path options.
MySQL-compatible fork with extra features.

## Usage

```powershell
.\run.ps1          # Install MariaDB (interactive path prompt)
...
1. **Dev directory** (default): `E:\dev\mariadb`
...
4. Check if MariaDB is already installed
